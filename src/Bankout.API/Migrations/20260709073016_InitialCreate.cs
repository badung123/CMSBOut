...
namespace Bankout.API.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "BankoutRequests",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RequestBankId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BankoutRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BankoutRequests_Agents_AgentId",
                        column: x => x.AgentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestBankOutId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BalanceHistories_BankoutRequests_RequestBankOutId",
                        column: x => x.RequestBankOutId,
                        principalTable: "BankoutRequests",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BalanceHistories_RequestBankOutId",
                table: "BalanceHistories",
                column: "RequestBankOutId");

            migrationBuilder.CreateIndex(
                name: "IX_BankoutRequests_AgentId",
